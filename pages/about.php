...
<section class="about-hero" style="padding:100px 24px 60px;background:#0A0A0A;text-align:center;">
    <p style="font-family:'Inter',sans-serif;font-size:0.65rem;letter-spacing:0.3em;color:#B8860B;margin-bottom:16px;text-transform:uppercase;"><?= htmlspecialchars($cb_about['about_small'] ?? 'ROYAL TURKISH CUISINE') ?></p>
...
<section class="about-content" style="padding:40px 24px 100px;background:#0A0A0A;">
    <div style="max-width:1200px;margin:0 auto;">
        <div class="about-two-col">
            ...
            <!-- Left: Text -->
            <div>
                <p style="font-family:'Inter',sans-serif;font-size:0.65rem;letter-spacing:0.3em;color:#B8860B;margin:0 0 12px;text-transform:uppercase;"><?= htmlspecialchars($cb_about['story_label'] ?? 'ROYAL TURKISH CUISINE') ?></p>
