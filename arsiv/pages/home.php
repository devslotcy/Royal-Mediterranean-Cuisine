...
<section class="hero-section" style="min-height:100vh;display:flex;flex-direction:column;align-items:center;justify-content:center;background:#0A0A0A;text-align:center;padding:40px 24px;position:relative;overflow:hidden;">
    ...
    <div class="hero-anim" style="display:flex;align-items:center;gap:16px;margin-bottom:40px;margin-top:-30px;">
        ...
        <span style="font-family:'Inter',sans-serif;font-size:0.65rem;letter-spacing:0.35em;color:#B8860B;text-transform:uppercase;"><?= cb($cb, 'hero_badge_label') ?></span>
        <div style="width:40px;height:1px;background:#B8860B;opacity:0.6;"></div>
    </div>

    <h1 class="hero-anim-2" style="font-family:'Playfair Display',serif;font-size:clamp(3rem,7vw,5.5rem);font-weight:700;color:white;margin:0;line-height:0.95;letter-spacing:0.02em;">ROYAL</h1>
...
<section id="branches" class="branches-section" style="padding:100px 24px;background:#050505;">
    <div style="max-width:1200px;margin:0 auto;">
        ...
        <div style="text-align:center;margin-bottom:64px;">
            ...
            <h2 style="font-family:'Playfair Display',serif;font-size:clamp(2rem,4vw,3.2rem);color:white;margin:0 0 16px;">Our Branches</h2>
        ...
        <div class="branches-grid" style="display:grid;grid-template-columns:1fr 1fr;gap:24px;">
            ...
            <div class="branch-card" style="padding:0;overflow:hidden;">
                ...
                <div class="branch-map" style="width:100%;height:220px;overflow:hidden;position:relative;">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3942.5!2d100.0624!3d9.5314!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3054f9b5f5d4b7a3%3A0x1234!2sRoyal+Mediterranean+Cuisine+Chaweng!5e0!3m2!1sen!2sth!4v1"
                ...
                <div style="padding:28px 32px 32px;">
                    <h3 style="font-family:'Playfair Display',serif;font-size:1.1rem;color:#71717a;margin:0 0 2px;font-weight:400;">Royal Mediterranean Cuisine –</h3>
                    ...
                    <div style="display:flex;flex-direction:column;gap:11px;margin-bottom:24px;">
                        ...
                        <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap;">
                            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#B8860B" stroke-width="1.5" style="flex-shrink:0;"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 13 19.79 19.79 0 0 1 1.61 4.38 2 2 0 0 1 3.58 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 9.91a16 16 0 0 0 6.16 6.16l1.02-.87a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
            ...
            <div class="branch-card" style="padding:0;overflow:hidden;">
                ...
                <div class="branch-map" style="width:100%;height:220px;overflow:hidden;position:relative;">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3944.2!2d100.0584!3d9.4672!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3054f7b5f5d4b7a3%3A0x5678!2sRoyal+Mediterranean+Cuisine+Lamai!5e0!3m2!1sen!2sth!4v1"
                        width="100%" height="100%" style="border:0;filter:invert(85%) hue-rotate(180deg) saturate(0.8);display:block;" allowfullscreen loading="lazy" referrerpolicy="no-referrer-when-downgrade">
                    </iframe>
                </div>
                <!-- Info -->
    ...
    <div style="max-width:1200px;margin:0 auto;">
        <div class="two-col" style="display:grid;grid-template-columns:1fr 1fr;gap:80px;align-items:start;">
            ...
            <div style="position:relative;display:flex;align-items:center;justify-content:center;">
                <img src="/public/images/front.png" alt="Royal Mediterranean Cuisine" style="width:100%;max-width:560px;height:auto;object-fit:cover;display:block;border:1px solid #1a1a1a;">
                <!-- Quote overlay -->
