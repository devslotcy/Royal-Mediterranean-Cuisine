...
<head>
    ...
    <meta name="author" content="Royal Mediterranean Cuisine">
    <link rel="canonical" href="<?= htmlspecialchars($canonical) ?>">

    <!-- Open Graph -->
    <meta property="og:site_name" content="Royal Mediterranean Cuisine">
    ...
    <meta property="og:image:alt" content="Royal Mediterranean Cuisine - Koh Samui">
    ...
    [
    {
        ...
        "@type": "WebSite",
        "name": "Royal Mediterranean Cuisine",
        "url": "<?= SITE_URL ?>",
    ...
    },
    {
        ...
        "@type": "Restaurant",
        "@id": "<?= SITE_URL ?>/#chaweng",
        "name": "Royal Mediterranean Cuisine – Chaweng",
    ...
    },
    {
        ...
        "@type": "Restaurant",
        "@id": "<?= SITE_URL ?>/#lamai",
        "name": "Royal Mediterranean Cuisine – Lamai",
...
<nav style="background:rgba(0,0,0,0.95);position:sticky;top:0;z-index:50;border-bottom:1px solid #2A2A2A;">
    <div style="max-width:1200px;margin:0 auto;padding:0 24px;display:flex;align-items:center;justify-content:space-between;height:64px;">
        ...
        <a href="<?= url($lang_code, 'home') ?>" style="display:flex;align-items:center;text-decoration:none;">
            ...
            <img src="/public/images/logo.png" alt="Royal Mediterranean Cuisine" style="height:40px;">
            <?php else: ?>
    ...
    <div id="mobile-menu" style="display:none;background:#111;border-top:1px solid #2A2A2A;padding:16px 24px;">
        ...
        <div style="margin-top:12px;padding-top:12px;border-top:1px solid #2A2A2A;display:flex;flex-wrap:wrap;gap:8px;">
            <?php foreach (SUPPORTED_LANGS as $l): ?>
